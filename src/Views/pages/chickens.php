    ...
    <div id="chickens-cards" class="chickens-cards">
        ...
        <div class="chicken-card card" data-id="<?= $ch['id'] ?>">
            ...
            <div class="chicken-card__body">
                ...
                <span class="chicken-status" style="background:<?= Chicken::statusColor($ch['status']) ?>"><?= Chicken::statusLabel($ch['status']) ?></span>
                ...
                <?php if ($ch['birth_date']): ?><p class="chicken-detail">Narozena: <?= date('d.m.Y', strtotime($ch['birth_date'])) ?></p><?php endif; ?>
